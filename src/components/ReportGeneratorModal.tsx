  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      autoTable(pdf, {
        ...
        columnStyles: {
          0: { cellWidth: 19 },   // Date
          1: { cellWidth: 25 },   // Compte
          2: { cellWidth: 36 },   // Description
          3: { cellWidth: 23 },   // Catégorie
          4: { cellWidth: 17 },   // Type
          5: { cellWidth: 31, halign: 'right' }, // Montant
          6: { cellWidth: 31, halign: 'right', fontStyle: 'bold' } // Solde
        },
