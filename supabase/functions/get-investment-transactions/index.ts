  ...
  try {
    ...
    const summary = {
      ...
      by_category: Object.entries(
        transactions?.reduce((acc: Record<string, { count: number; total: number; expenses: number; income: number }>, tx: any) => {
      ...
      by_account: Object.entries(
        transactions?.reduce((acc: Record<string, { count: number; expenses: number; income: number; transfers: number }>, tx: any) => {
